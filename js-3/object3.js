...
receta.ingredientes.push(ingredientePan);

//Agrega otro ingrediente al arreglo con las siguientes propiedades:
//nombre: “Queso”
//cantidad: 1
let ingredientesQueso = {
    nombre: "queso",
    cantidad: 1 
}
receta.ingredientes.push(ingredientesQueso);
...
let totalCantidadIngredientes = 0;
receta.ingredientes.forEach((ingredienes) => {
    totalCantidadIngredientes += ingredienes.cantidad;
});

console.log("Cantidad Total " + totalCantidadIngredientes);